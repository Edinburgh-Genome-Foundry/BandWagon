...
latex_documents = [
  ('index', 'Bandwagon.tex', u'Bandwagon Documentation',
   u'Zulko', 'manual'),
]
...
man_pages = [
    ('index', 'Bandwagon', u'PACKAGE_NAME Documentation',
     [u'Zulko'], 1)
]
...
texinfo_documents = [
  ('index', 'Bandwagon', u'Bandwagon Documentation',
   u'Zulko', 'Bandwagon', 'One line description of project.',
   'Miscellaneous'),
]
